...
namespace SelectAll
{
    public partial class PayMentOneAll : FormBase
    {
        public PayMentOneAll ( )
        {
            InitializeComponent( );
        ...
        private void PayMentOneAll_Load ( object sender ,EventArgs e )
        {
        ...
        void assignMent ( )
        {
            lookUpEdit1.Properties.DataSource = _bll.GetDataTableOfOddNum( );
            lookUpEdit1.Properties.DisplayMember = "YZ001";
        }
        ...
        private void button1_Click ( object sender ,EventArgs e )
        {
            ...
            if ( !string.IsNullOrEmpty( lookUpEdit1.Text ) )
                strWhere = strWhere + " AND YZ001='" + lookUpEdit1.Text + "'";
            if ( !string.IsNullOrEmpty( textBox1.Text ) )
                strWhere = strWhere + " AND YZ009='" + dateTimePicker1.Value + "'";
            pageToDataTable( );
        }
        ...
        {
            cn1 = cn2 = gridView1 . GetFocusedRowCellValue ( "YZ001" ) . ToString ( );
            cn1 = "YZ001='" + cn1 + "'";
        ...
        protected override void sure ( )
        {
            ...
            {
                oddNum = gridView1 . GetDataRow ( i ) [ "YZ001" ] . ToString ( );
