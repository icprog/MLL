   ...
   public static  class DateDay
    {
        ...
        public static bool threeTwoNumTb ( DevExpress.XtraEditors.TextEdit tb )
        {
            bool res = Regex.IsMatch( tb.Text ,@"^\d{1,1}(?:\.\d{1,2})?$" );
            return res;
        }
        ...
        public static bool foreOneNum ( DevExpress.XtraEditors.TextEdit cb )
        {
            bool res = Regex.IsMatch( cb.Text ,@"^\d{1,3}(?:\.\d{1,1})?$" );
            return res;
        }
...
　　    ^(-([1-9]d*.d*|0.d*[1-9]d*))|0?.0+|0$　　//匹配非正浮点数（负浮点数 + 0） 
        */
        ...
        /// <param name="e">键盘按下</param>
        /// <param name="tb">Textbox</param>
        public static void fractionTb ( KeyPressEventArgs e ,DevExpress.XtraEditors.TextEdit tb )
        {
            //e.KeyChar < 48 || e.KeyChar > 57表示0-9的数字
            //e.KeyChar != 46 表示小数点
            //e.KeyChar != 8 表示退格键
