...
{
    public class StandardAuditTreBll
    {
        Dao.StandardAuditTreDao _dal=null;
        public StandardAuditTreBll ( )
        {
            _dal = new Dao . StandardAuditTreDao ( );
        }
        ...
        /// <returns></returns>
        public bool Save ( DataTable table ,MulaolaoLibrary . StandardAuditTreCFEntity _cd ,string logins )
        {
        ...
        /// <returns></returns>
        public bool Edit ( DataTable table ,MulaolaoLibrary . StandardAuditTreCFEntity _cd ,string logins ,List<string> strList )
        {
